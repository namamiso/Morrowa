...
class ThemeProvider @Inject constructor(
    ...
    private var accentColor: ColorOption = preferenceManager2.accentColor.defaultValue
    private var colorStyle: ColorStyle = preferenceManager2.colorStyle.defaultValue
